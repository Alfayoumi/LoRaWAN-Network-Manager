import pytest
from apicelery.dependencies.utility_functions import get_logger, LoggerConfig
import logging
...
@pytest.mark.parametrize(
    ...
    [
        LoggerConfig(
            loglevel="debug",
            logfile="./apicelery.log",
            logger_name="apicelery_logger",
            max_bytes=100000,
            backup_count=10,
        ),
        LoggerConfig(
